...
#' @rdname plot
#' @method plot IntensityL02
#' @export

plot.IntensityL02 <- function(x, y,
                              labels = c(
  ...
  if (!is.na(labels[[3]])) {
    ...
    my_layout <-
      matrix(c(rep(1, 6), NA, rep(rep(2:3, c(3, 4)), 20), rep(4:5, c(3, 3)), NA),
      ncol = 7,
      byrow = TRUE)
...
#' @rdname plot
#' @aliases plot,plot.IntensityL01,ANY-method
setMethod(f = "plot", signature = "IntensityL01", definition = plot.IntensityL01)


#' @rdname plot
#' @aliases plot,plot.IntensityL02,ANY-method
setMethod(f = "plot", signature = "IntensityL02", definition = plot.IntensityL02)


#' @rdname plot
#' @aliases plot,plot.IntensityL03,ANY-method
setMethod(f = "plot", signature = "IntensityL03", definition = plot.IntensityL03)
