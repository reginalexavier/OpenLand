...
### The input data
The function used to extract the data is `contingencyTable()`, whichthis function take a list of raster layer (`RasterBrick`, `RasterStack` or a path to a folder containing the rasters). The name of the rasters must be in the format ("some_text" `+` "underscore" `+` "the_year") like "landscape_2019".
