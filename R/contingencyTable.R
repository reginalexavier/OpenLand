...
#' \code{\link[raster]{raster}} for more information about supported filetypes.
...
#'   }
#'   \item \code{lulc_Onestep}:\code{<tibble>} Contingency table for the entire analysed period \emph{[Y1, YT]}, containing
