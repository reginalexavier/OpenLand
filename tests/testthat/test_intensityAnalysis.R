...
test_that("Behavior of the intensityAnalysis", {
  ...
  expect_equal(
    demo_int_km2$interval_lvl$intervalData$U,
  ...
  expect_equal(
    demo_int_km2$category_lvlGain$categoryData$GG_km2,
    demo_int_pixel$category_lvlGain$categoryData$GG_pixel / 1000000
  )
  expect_equal(
    demo_int_km2$category_lvlLoss$categoryData$GL_km2,
  ...
  expect_equal(
    demo_int_km2$transition_lvlGain_n$transitionData$T_i2n_km2,
    demo_int_pixel$transition_lvlGain_n$transitionData$T_i2n_pixel / 1000000
  )
  expect_equal(
    demo_int_km2$transition_lvlLoss_m$transitionData$T_m2j_km2,
  ...
  expect_equal(
    demo_int_km2$category_lvlGain$categoryStationarity$Stationarity,
    demo_int_pixel$category_lvlGain$categoryStationarity$Stationarity
  )
  expect_equal(
    demo_int_km2$category_lvlLoss$categoryStationarity$Stationarity,
    demo_int_pixel$category_lvlLoss$categoryStationarity$Stationarity
  )

  expect_equal(
    demo_int_km2$transition_lvlGain_n$transitionStationarity$Stationarity,
    demo_int_pixel$transition_lvlGain_n$transitionStationarity$Stationarity
  )
  expect_equal(
    demo_int_km2$transition_lvlLoss_m$transitionStationarity$Stationarity,
