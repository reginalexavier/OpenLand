...
In this step we have to  extract the values from our rasters and save them in tables for next steps of analysis. The function in `OpenLand` that compute that is the `contingencyTable()`. This function returns `r length(SL_2002_2014)` objects: `r names(SL_2002_2014)`.
