...
#'
#' @param dataset \code{<tibble>}. A table of the multi step transitions (\code{lulc_Multistep}) generated by \code{\link{contingencyTable}}.
#' @param legendtable \code{<tibble>}. A table containing the LUC legend items and their respective color (\code{tb_legend}).
